...
<div class="aside-widget">
	...
	<div class="social-widget">
		<ul>
			<li>
				<a href="https://www.facebook.com/{{ $web->faceook }}" class="social-facebook">
					<i class="fa fa-facebook"></i>
					<!-- <span>21.2K<br>Followers</span> -->
				</a>
			</li>
			<li>
				<a href="https://www.twitter.com/{{ $web->twitter }}" class="social-twitter">
					<i class="fa fa-twitter"></i>
					<!-- <span>10.2K<br>Followers</span> -->
				</a>
			</li>
			<li>
				<a href="https://www.instagram.com/{{ $web->instagram }}" class="social-instagram">
